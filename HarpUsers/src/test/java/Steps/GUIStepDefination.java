...
public class GUIStepDefination {
	...
	public void user_is_at_homepage() throws InterruptedException {
		...
		for (int rowNum = 3; rowNum <= rowCount; rowNum++) {
			...
			driver.findElement(By.xpath("//input[@name='email']")).sendKeys(Readexcel.getCellData("sheet1", "@", rowNum));
			
			driver.findElement(By.xpath("//input[@name='confirmEmailAddress']")).sendKeys(Readexcel.getCellData("sheet1", "ConfirmEmail", rowNum));
			
			driver.findElement(By.xpath("//input[@name='confirmEmailAddress']")).sendKeys(Readexcel.getCellData("sheet1", "@", rowNum));
...
//==================================================================Savynt Access Feature ===================================================================================================
	...
	private void user_is_at_savynt_login_page() {
